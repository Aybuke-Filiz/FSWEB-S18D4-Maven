...
public class GlobalExceptionHandler {
    @ExceptionHandler
    private ResponseEntity<BurgerErrorResponse> handleExcepiton(BurgerException exception){
    ...
    @ExceptionHandler
    private ResponseEntity<BurgerErrorResponse> handleExcepiton(Exception exception){
